        ...
        $.widget('toc.tocify', {
                    ...
                    $('html, body')
                        ...
                        .done(function () {
                            ...
                            if (self.options.extendPage) {
                                ...
                                if (
                                    (self.webkit &&
                                        winScrollTop >= scrollHeight - winHeight - self.options.extendPageOffset) ||
                                    (!self.webkit &&
                                        winHeight + winScrollTop > docHeight - self.options.extendPageOffset)
                                ) {
                                    if (!$(extendPageClass).length) {
                                        lastElem = $(
                                            'div[data-unique="' + $(itemClass).last().attr('data-unique') + '"]'
                                        );
            ...
            calculateHeights: function () {
                ...
                anchors.each(function (idx) {
                    var distance =
                        ($(this).next().length ? $(this).next() : $(this)).offset().top - self.options.highlightOffset;
            ...
            show: function (elem, scroll) {
                ...
                // If the current subheader parent element is not a header
                    ...
                    // Hides all non-active sub-headers
                    self.hide(
                        $(subheaderClass).not(elem.closest(headerClass).find(subheaderClass).not(elem.siblings()))
                    );
                }
